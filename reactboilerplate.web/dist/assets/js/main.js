  ...
  render: function() {
    return (
      React.createElement("div", {className: "row"}, 
        React.createElement("div", {className: "small-12 medium-6 columns text-left"}, 
          "© ",  (new Date()).getFullYear(), ". Products of", 
          React.createElement("a", {href: "#"}, " APPNAME ")
        ), 

        React.createElement("div", {className: "small-12 medium-6 columns text-right"}, 
